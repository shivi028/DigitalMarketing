...
const Feature = () => {
  ...
  {/* Lighter Pastel Purple Background */}
  <div className="absolute h-full w-full bg-[radial-gradient(circle_at_50%_120%,rgba(235,215,255,0.5),rgba(180,150,220,0.2))]" />
  <div className="absolute h-full w-full bg-[linear-gradient(to_right,rgba(235,215,255,0.2)_1px,transparent_1px),linear-gradient(to_bottom,rgba(235,215,255,0.2)_1px,transparent_1px)] bg-[size:4rem_4rem]" />
  
  {/* Softer Light Pastel Purple Overlay */}
  <div className="absolute h-full w-full bg-[radial-gradient(circle_at_50%_50%,rgba(255,240,255,0.6),transparent_70%)]" />
</div>
        ...
        <div className="relative z-10">
          <div className="container mx-auto px-4 py-24 text-center">
            ...
            >
              ...
              <h2 className="mt-6 text-3xl md:text-4xl text-white md:text-[#2e253c]">
          ...
          <div className="container mx-auto px-4">
            <div className="mb-16 text-center">
              <motion.h2
                ...
                className="text-4xl font-bold text-white md:text-[#2e253c] sm:text-4xl"
              >
                Our Products
              </motion.h2>
              <motion.p
                ...
                className="mt-4 text-xl md:text-xl text-white md:text-[#2e253c]"
              >
