...
//   return (
//     <div className="min-h-screen -z-10  bg-gradient-to-br from-[#020B2D] via-[#0B1351] via-[#14194B] via-[#2D2F45] to-[#EAEAEA]">
//       <div className="bg-gradient-to-bl from-[#3D9ECB] via-[#7156A2] to-[#EAEAEA]">
//       <header className="container mx-auto px-4">
//         <nav className="flex items-center justify-between py-4">
//           <div className="flex items-center gap-2">
//             <Image
//               // src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-xFUcqzQnFnuA7bTlRJFIrdirYEdi4l.png"
//               src='/Image/demo.png'
//               alt="Upcloud Logo"
//               width={40}
//               height={40}
//               className="w-8 h-8"
//             />
//             <span className="text-white text-xl font-semibold">Upcloud</span>
//           </div>
